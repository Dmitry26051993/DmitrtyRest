...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Admin\PycharmProjects\pythonRest\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Admin\PycharmProjects\pythonRest\venv\Scripts\deactivate.nu'
